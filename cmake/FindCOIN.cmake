...
IF(COIN_FOUND)
    ...
    #SET(COIN_CBC_LIBRARIES "${COIN_CBC_LIBRARY};${COIN_CBC_SOLVER_LIBRARY};${COIN_CGL_LIBRARY};${COIN_OSI_LIBRARY};${COIN_OSI_CLP_LIBRARY};${COIN_CLP_LIBRARIES};${COIN_OSI_CBC_LIBRARY}")
    SET(COIN_CBC_LIBRARIES "${COIN_CBC_LIBRARIES};${COIN_CBC_LIBRARIES}")
