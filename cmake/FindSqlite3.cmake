...
FIND_PATH(SQLITE3_INCLUDE_DIR sqlite3.h HINTS "${DEPS_ROOT_DIR}/include")

FIND_LIBRARY(SQLITE3_LIBRARY_RELEASE NAMES sqlite3 HINTS "${DEPS_ROOT_DIR}/lib")

FIND_LIBRARY(SQLITE3_LIBRARY_DEBUG NAMES sqlite3 sqlite3d
             HINTS "${DEPS_ROOT_DIR}/lib" /usr/lib/debug/usr/lib/)
