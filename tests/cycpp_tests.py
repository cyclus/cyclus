...
def test_infiletodb_read_member():
    ...
    exp_gen = (
        ...
        '      std::string key;\n'
        '      {\n'
        '        std::string key_in = cyclus::Query<std::string>(sub, "name", i0);\n'
        '        key = key_in;\n'
        '      }\n'
        '      std::vector< std::vector< std::pair< double, std::pair< int, std::list< std::set< bool > > > > > > val;\n'
        '      {\n'
        '        cyclus::InfileTree* bub = sub->SubTree("efficiencies", i0);\n'
        '        cyclus::InfileTree* sub = bub;\n'
        ...
        '          {\n'
        '            cyclus::InfileTree* bub = sub->SubTree("val", i1);\n'
        '            cyclus::InfileTree* sub = bub;\n'
        '            int n = sub->NMatches("val");\n'
        ...
        '                  {\n'
        '                    cyclus::InfileTree* bub = sub->SubTree("second", i3);\n'
        '                    cyclus::InfileTree* sub = bub;\n'
        '                      int first;\n'
        '                      {\n'
        ...
        '                      {\n'
        '                        cyclus::InfileTree* bub = sub->SubTree("second", i4);\n'
        '                        cyclus::InfileTree* sub = bub;\n'
        '                        int n = sub->NMatches("val");\n'
        ...
        '                          std::set< bool > elem;\n'
        '                          {\n'
        '                            cyclus::InfileTree* bub = sub->SubTree("val", i5);\n'
        '                            cyclus::InfileTree* sub = bub;\n'
        '                            int n = sub->NMatches("val");\n'
        ...
        '                              bool elem;\n'
        '                              {\n'
        '                                bool elem_in = cyclus::Query<bool>(sub, "val", i6);\n'
        '                                elem = elem_in;\n'
        '                              }\n'
        '                              elem_in.insert(elem);\n'
        '                            }\n'
