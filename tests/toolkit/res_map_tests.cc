...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, GetCount_Empty) {
  ASSERT_NO_THROW(store_.count());
  EXPECT_EQ(store_.count(), 0);
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, GetCount_Filled) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveQty_ExceptionsEmpty) {
  Product::Ptr p;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveQty_ExceptionsFilled) {
  Product::Ptr p;
  double qty = cap + overeps;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveQty_SingleNoSplit) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveQty_SingleWithSplit) {
  // pop one no splitting leaving one mat in the store
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveQty_DoubleWithSplit) {
  // pop one no splitting leaving one mat in the store
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveNum_ExceptionsFilled) {
  ProdVec manifest;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveNum_ZeroFilled) {
  ProdVec manifest;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveNum_OneFilled) {
  ProdVec manifest;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveNum_TwoFilled) {
  ProdVec manifest;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, RemoveOne_Filled) {
  Product::Ptr mat;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, PushAll_Empty) {
  ASSERT_NO_THROW(store_.capacity(cap));
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, PushAll_ResCast) {
  ResVec rs;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, PushAll_NoneEmpty) {
  ProdVec manifest;
  ASSERT_NO_THROW(store_.capacity(cap));
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, PushAll_RetrieveOrderEmpty) {
  Product::Ptr mat;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, PushAll_OverCapacityEmpty) {
  ASSERT_NO_THROW(store_.capacity(cap));
  ASSERT_NO_THROW(store_.Push(mats));
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(ResMapTest, PushAll_DuplicateEmpty) {
