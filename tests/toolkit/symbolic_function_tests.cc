...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
SymFunction::Ptr SymbolicFunctionTests::GetExpFunction() {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
SymFunction::Ptr SymbolicFunctionTests::GetLinFunction() {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
SymFunction::Ptr SymbolicFunctionTests::GetPiecewiseFunction() {
  SetUpPiecewiseEnvironment();
  SymFunction::Ptr lin = GetLinFunction();
  SymFunction::Ptr exp = GetExpFunction();
...
TEST_F(SymbolicFunctionTests, linearfunc) {
  SymFunction::Ptr f = GetLinFunction();
...
TEST_F(SymbolicFunctionTests, expfunc) {
  SymFunction::Ptr f = GetExpFunction();
...
TEST_F(SymbolicFunctionTests, piecewisefunc) {
  ...
  SymFunction::Ptr f = GetPiecewiseFunction();
