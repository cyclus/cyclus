...
/**
   ...
   The NullRegion is a region type in Cyclus that is associated with a list 
   ...
   NullRegion behavior is comprehensively defined by the following parameters:
   ...
   NullRegion simply passes that message either up the hierarchy to the 
