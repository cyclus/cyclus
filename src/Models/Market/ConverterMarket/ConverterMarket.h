...
/**
   ...
   The ConverterMarket is a market type in Cyclus which receives 
   requests and offers for two different commodities, calls an 
   appropriate converter model, and matches appropriate offers and 
   requests according to a scheme much like the GreedyMarket. Either the 
   offer or request must be for the characteristic commodity of that 
   Market. The ConverterMarket is instantiated at the beginning of the 
   ...
   The ConverterMarket starts operation at the beginning of the 
   simulation and ends operation at the end of the simulation. It 
   collects offers and requests for its characteristic commodities. It 
   employs a converter model to make the appropiate conversions into a 
   single commodity. Once all requests and offers are of the same 
   commodity type, it matches offers and requests according to the 
   greedy algorithm, matching the largest request with the first offers 
   until it is filled and proceeding to fill other requests only if the 
   first large request is filled or is determined to be too large to 
   fill with all offers. Once matches are made, the market dictates the 
 */
 ...
 */
 ...
 private:
  ...
  /**
     The name of the converter model that this market relies on to make 
   */
