...
void RandomNumberGenerator::Initialize(SimInfo si) {
  ...
  CLOG(LEV_INFO1) << "Pseudo random number generator initialized with seed: "
                  << si.seed;
}
...
int RandomNumberGenerator::random_uniform_int(int low, int high) {
  ...
  boost::random::variate_generator<Generator&,
...
double RandomNumberGenerator::random_normal_real(double mean, double std_dev,
...
int RandomNumberGenerator::random_normal_int(double mean, double std_dev,
                                             int low, int high) {
  boost::random::normal_distribution<> dist(mean, std_dev);
  boost::random::variate_generator<Generator&,
                                   boost::random::normal_distribution<>>
