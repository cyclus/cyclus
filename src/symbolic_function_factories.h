...
class SymbFunctionFactory {
 public:
   ...
   */
  virtual SymFunctionPtr GetFunctionPtr(std::string params) = 0;
};
...
class LinFunctionFactory : public SymbFunctionFactory {
 public:
   ...
   */
  virtual SymFunctionPtr GetFunctionPtr(std::string params);
};
...
class PiecewiseFunctionFactory : public SymbFunctionFactory {
 public:
   ...
   */
  void AddFunction(SymFunctionPtr function, double starting_coord = 0.0,
...
class BasicFunctionFactory {
 public:
  ...
  /**
     ...
     @return the function
   */
  SymFunctionPtr GetFunctionPtr(std::string type, std::string params);
