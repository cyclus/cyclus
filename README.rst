...
.. code-block:: bash
    ...
    .../cyclus/cyclus$ python setup.py --prefix=../install --cycloptsRoot=../install
...
.. code-block:: bash
    ...
    .../cyclus/cyclus$  python setup.py --prefix=../install --coinRoot=path/to/coin --cycloptsRoot=../install
